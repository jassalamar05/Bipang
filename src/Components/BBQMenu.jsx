...
export default function BBQ(){
    return(
        <>
         <main className="mt-5 px-5 sm:px-10 md:px-12 md:mt-12 lg:mt-20 sm:flex-col sm:justify-center md:flex">
                    <section>
                ...
                <section className=" grid grid-cols-1 lg:grid-cols-3">
                    ...
                    <div className="flex mt-10 px-2">
                        <div className="bg-gray-200 h-full w-full rounded-md">
                            ...
                            <p className="text-base  font-bold text-center">Family BBQ Reservations</p>
                            ...
                            <div className="flex gap-2 justify-center py-4">
                                <div className="font-play text-white bg-cyan-900 py-1 px-2 rounded-md">30</div>
                                <div className="font-play text-white bg-cyan-900 py-1 px-2 rounded-md">30</div>                                  
                                <div className="font-play text-white bg-cyan-900 py-1 px-2 rounded-md">30</div>
                                <div className="font-play text-white bg-cyan-900 py-1 px-2 rounded-md">30</div>
                            </div>
                            ...
                            <div className="flex justify-center gap-4 ">
                                <p className="font-play text-xl font-bold text-gray-700">$98</p>
                                <p className="font-play text-2xl font-bold text-cyan-800 ">$67</p>
                            </div>
        
                            {/* BUTTON  */}
                            <div className="flex justify-center py-2">
                            <button className="bg-yellow-500 flex items-center gap-2 p-2 text-xs text-white rounded-md"><i className="fa-solid fa-mobile-button"></i>BUY ON APP</button>
                            </div>
